...
public class LoginActivity extends AppCompatActivity {
    ...
    private void updateFirebase(Users userData) {
        ...
        String username = userData.username; // Get the username from the input field
        ...
        userInfo.child("username").setValue(userData.getUsername());
        userInfo.child("email").setValue(userData.getEmail());
            ...
            mAuth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Constants.currentUserName=userData.username;
